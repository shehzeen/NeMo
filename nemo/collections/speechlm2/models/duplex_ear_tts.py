...
def setup_rvq_audio_codec(model):
    ...
    with fp32_precision():
        model.audio_codec = RVQVAEModel.from_pretrained(model.cfg.pretrained_ae_dir).eval()
...
class DuplexEARTTS(LightningModule, HFHubMixin):
    ...
    def on_train_epoch_start(self) -> None:
        ...
        # The isinstance check prevents infinite recursion, since setup_rvq_audio_codec may already return a GroupedCodec when the codec is set to fp32.
