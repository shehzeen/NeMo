...
@experimental
class SSLDisentanglerMLM(ModelPT):
    """
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor_disentangler = SSLDisentanglerMLM.from_config_dict(self._cfg.preprocessor)
        self.encoder = SSLDisentanglerMLM.from_config_dict(self._cfg.encoder)
        ...
        if "loss_list" in self._cfg:
            ...
            for decoder_loss_name, decoder_loss_cfg in self._cfg.loss_list.items():
                new_decoder_loss = {
                    'decoder': SSLDisentanglerMLM.from_config_dict(decoder_loss_cfg.decoder),
                    'loss': SSLDisentanglerMLM.from_config_dict(decoder_loss_cfg.loss),
                }
            ...
            self.spec_augmentation = SSLDisentanglerMLM.from_config_dict(self._cfg.spec_augment)
    ...
    def forward_with_masking(self, input_signal=None, input_signal_length=None, normalize_content=True):
        ...
        for key in batch.keys():
            if key == 'sv':
                ...
                (
                    ...
                    content_log_probs,
                    encoded_len,
                ) = self.forward_with_masking(input_signal=signal, input_signal_length=signal_len)
