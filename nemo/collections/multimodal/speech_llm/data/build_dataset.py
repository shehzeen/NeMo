...
from nemo.collections.multimodal.speech_llm.parts.utils.data_utils import TTSTextProcessing
...
def build_speechllm_dataset(model_instance, data_cfg, is_train):
    ...
    if data_cfg.get("use_lhotse"):
        tp = TTSTextProcessing(
            model_instance.tokenizer, data_cfg.lm_vocab_size, data_cfg.g2p_conf
        )
        return LhotseAudioQuestionAnswerDataset(
            ...
            task_templates=model_instance.task_templates,
            pseudo_tokens=model_instance.pseudo_tokens,
        )
