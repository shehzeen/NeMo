...
def main():
    ...
    parser.add_argument('--hparams_file', type=str, default="/Data/T5Plus_Ckpts_New/multilingual_checkpoints/CML_DecoderContext_FilteredData_WithRivaSpanish_WithFixes_hparams.yaml")
    parser.add_argument('--checkpoint_file', type=str, default="/Data/T5Plus_Ckpts_New/multilingual_checkpoints/CML_DecoderContext_FilteredData_WithRivaSpanish_WithFixes_epoch13.ckpt")
    parser.add_argument('--codecmodel_path', type=str, default="/Data/Checkpoints/AudioCodec_21Hz_no_eliz.nemo")
    # parser.add_argument('--datasets', type=str, default="spanish_cml,german_cml,french_cml,italian_cml,portuguese_cml,polish_cml,dutch_cml")
    parser.add_argument('--datasets', type=str, default="polish_cml,dutch_cml,spanish_cml,german_cml,french_cml,italian_cml")
    ...
    parser.add_argument('--out_dir', type=str, default="/Data/ICMLEvals_T5TTS/F2FEvals/MultiLingualEvals")
